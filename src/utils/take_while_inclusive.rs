// Implementation taken from https://github.com/rust-itertools/itertools/pull/616/files
// TODO Replace with itertools::take_while_inclusive once it is merged

use core::iter::FusedIterator;

pub trait TakeWhileInclusiveIterExt: Iterator {
...
impl<I: Iterator> TakeWhileInclusiveIterExt for I {}
